//! A verbatim copy of the original `convert_to_cnf` implementation (minus its
//! `println!`s), kept as a correctness oracle and a benchmark baseline. The
//! optimized implementation in `src/lib.rs` must produce identical output.
#![allow(dead_code, unused_variables)]

use autosat::{Cnf, SatClause, SatLiteral, SatOutput};
